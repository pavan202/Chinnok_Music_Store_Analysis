...
-- SUBMISSION BY: PAVAN KUMAR REDDY PYLA--
-- PROJECT: CHINOOK MUSIC STORE--
-- SKILL USED: MYSQL WORKBENCH--
-- BATCH: DATA SCIENCE COURSE APRIL 2025--
...
-- ------------------------------------OBJECTIVE QUESTIONS - SQA QUERIES---------------------------------------------------------
...
-- prioritized for advertising and promotion in the USA based on genre sales analysis ?----------------------------------------------
SELECT
	g.genre_id,
	g.name AS genre_name,
	al.album_id,
